...
requirejs.config({
    ...
    paths: {
        ...
        // the HTML page.
		chilipeppr_ready: '//localhost:8123/main',
		chilipeppr_init2: '//localhost:8123/app2',
		chilipeppr_init: '//localhost:8123/app',
		google: '//www.google-analytics.com/analytics',
        jquery: '//localhost:8123/jquery-2.1.0.min',
		bootstrap: '//localhost:8123/bootstrap/bootstrap_3_1_1.min',
//		bootstrap: '//netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min',
		amplify: '//localhost:8123/amplify/amplify',
		jquerycookie: '//localhost:8123/jquery-cookie/jquery.cookie',
		jqueryui: '//localhost:8123/js/jquery-ui-1.10.4/ui/jquery.ui.core',
        jqueryuiWidget: '//localhost:8123/js/jquery-ui-1.10.4/ui/jquery.ui.widget',
        jqueryuiMouse: '//localhost:8123/js/jquery-ui-1.10.4/ui/jquery.ui.mouse',
        jqueryuiResizeable: '//localhost:8123/js/jquery-ui-1.10.4/ui/jquery.ui.resizable',
