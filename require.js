...
requirejs.config({
    ...
    paths: {
        ...
        // the HTML page.
		chilipeppr_ready: '//localhost/DidaOffline//main',
		chilipeppr_init2: '//localhost/DidaOffline//app2',
		chilipeppr_init: '//localhost/DidaOffline//app',
		google: '//www.google-analytics.com/analytics',
        jquery: '//localhost/DidaOffline//jquery-2.1.0.min',
		bootstrap: '//localhost/DidaOffline//bootstrap/bootstrap_3_1_1.min',
//		bootstrap: '//netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min',
		amplify: '//localhost/DidaOffline//amplify/amplify',
		jquerycookie: '//localhost/DidaOffline//jquery-cookie/jquery.cookie',
		jqueryui: '//localhost/DidaOffline//js/jquery-ui-1.10.4/ui/jquery.ui.core',
        jqueryuiWidget: '//localhost/DidaOffline//js/jquery-ui-1.10.4/ui/jquery.ui.widget',
        jqueryuiMouse: '//localhost/DidaOffline//js/jquery-ui-1.10.4/ui/jquery.ui.mouse',
        jqueryuiResizeable: '//localhost/DidaOffline//js/jquery-ui-1.10.4/ui/jquery.ui.resizable',
